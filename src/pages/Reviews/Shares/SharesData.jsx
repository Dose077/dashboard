...
export default function SharesData() {
  ...
  return  (
    <>
      ...
      <div className="bg-[#DCE9F9]  h-screen flex justify-center overflow-y-scroll py-5 ">
        <div className="  h-[1000px] flex flex-col items-center gap-5 rounded-md p-5">
          <div className="bg-white h-[95%] flex items-center justify-center  rounded-md relative">
