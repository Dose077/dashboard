  ...
  return (
    <>
      <div className="bg-white border w-24 h-screen flex flex-col items-center justify-center">
        <div className=" w-[90%] h-[95%] flex flex-col items-center justify-between gap-8">
          <div>
            <span>
              <svg
            ...
            <ul className="bg-[#6e8bb727] mt-[24px] gap-1 rounded-md w-10 h-[305px] flex flex-col ul-item overflow-hidden">
              <Link
                to="/dashboard"
              ...
              <Link
                to=""
                className="text-2xl rounded-md text-[#6E8BB7] active:bg-blue-500 focus-within:bg-blue-500 focus-within:text-white"
              >
                <li>
                  <IoMdPeople />
                </li>
          ...
          <ul className="gap-2  w-10 flex items-center flex-col ul-item overflow-hidden">
            <NavLink>
              <svg
                width="16"
                height="20"
              ...
              >
                <path
                  d="M8.00002 20C9.10002 20 10 19.1 10 18H6.00002C6.00002 19.1 6.89002 20 8.00002 20ZM14 14V9C14 5.93 12.36 3.36 9.50002 2.68V2C9.50002 1.17 8.83002 0.5 8.00002 0.5C7.17002 0.5 6.50002 1.17 6.50002 2V2.68C3.63002 3.36 2.00002 5.92 2.00002 9V14L0.710021 15.29C0.080021 15.92 0.520021 17 1.41002 17H14.58C15.47 17 15.92 15.92 15.29 15.29L14 14Z"
                  fill="#6E8BB7"
                />
              </svg>
            </NavLink>
